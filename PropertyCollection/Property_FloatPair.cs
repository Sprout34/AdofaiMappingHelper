...
namespace MappingHelper.PropertyCollection
{
    ...
    {
        public Property_FloatPair(string name, object value_default = null, object min = null, object max = null, string key = null, bool canBeDisabled = false, bool startEnabled = false, Dictionary<string, string> enableIf = null, Dictionary<string, string> disableIf = null)
